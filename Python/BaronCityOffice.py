...
class BaronCityOffice(ptResponder):
    ...
    def OnFirstUpdate(self):
        ...
        #- kChronicleVarType = 0
        #- vault = ptVault()
        #- if not isinstance(vault, type(None)):
        ...
        #-             kChronicleVarName, kChronicleVarType, "%d" % (1))
        #-         PtDebugPrint("%s:\tentered new chronicle counter %s"
        #-                      % (kModuleName, kChronicleVarName))
        #-     else:
        #-         import string
        ...
        #-         entry.save()
        #-         PtDebugPrint("%s:\tyour current count for %s is %s"
        #-                      % (kModuleName,
        #-                      kChronicleVarName,
        #-                      entry.chronicleGetValue()))
        #- else:
        #-     PtDebugPrint("%s:\tERROR trying to access vault -- "
        #-                  "can't update %s variable in chronicle."
        #-                  % (kModuleName, kChronicleVarName))
        pass
