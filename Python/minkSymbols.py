...
# define globals
RegionToResponder = {regCave01.id: respCave01,
...
class minkSymbols(ptResponder):
    ...
    def __init__(self):
        ...
        PtDebugPrint("__init__: minkSymbols v{}".format(self.version))
    ...
    def OnNotify(self, state, id, events):
        PtDebugPrint("minkSymbols.OnNotify():  state={} id={} events={}".format(state, id, events))

        if id in RegionToResponder.keys():
            PtDebugPrint("minkSymbols.OnNotify():  Region {} triggered".format(id))
