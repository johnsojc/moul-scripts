...
class xPotsSymbol(ptResponder):
    ...
    def OnFirstUpdate(self):
        ...
        if (not (type(sdlSaveCloth1.value) is str and sdlSaveCloth1.value != "")
                or not (type(sdlSaveCloth2.value) is str and sdlSaveCloth2.value != "")
                or not (type(sdlSaveCloth3.value) is str and sdlSaveCloth3.value != "")
                or not (type(sdlSaveCloth4.value) is str and sdlSaveCloth4.value != "")
