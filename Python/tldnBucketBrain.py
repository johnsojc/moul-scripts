...
class tldnBucketBrain(ptResponder):
    ...
    def OnNotify(self, state, id, events):
        ...
        if id == actDumpAvatar.id:
            ...
            if bucketAtDump is None or bucketAtDump < 0:
    ...
    def OnControlKeyEvent(self, controlKey, activeFlag):
        ...
        if controlKey == (PlasmaControlKeys.kKeyExitMode or controlKey == PlasmaControlKeys.kKeyMoveBackward or
                          controlKey == PlasmaControlKeys.kKeyRotateLeft or controlKey == PlasmaControlKeys.kKeyRotateRight or
                          controlKey == PlasmaControlKeys.kKeyMoveForward):
            PtDisableControlKeyEvents(self.key)
