...
class nb01RPSGame(ptResponder):
    ...
    def __init__(self):
        ...
        self.responderList = [respRock0, respPaper0, respScissors0, respRock1, respPaper1, respScissors1, respRock2, respPaper2,
                              respScissors2, respRock3, respPaper3, respScissors3, respRock4, respPaper4, respScissors4]
    ...
    def IGetHeekGameCli(self):
        ...
        if (gameCli is not None) and (PtIsHeekGame(gameCli.gameTypeID())):
