    ...
    def OnBackdoorMsg(self, target, param):
        if target.lower() == "cgz":
            if param.lower() == "solve":
                PtDebugPrint("xMarkerGameManager.OnBackdoorMsg(cgz, solve):\t*@#[ CHEAT ACTIVATED! ]#@*")
                PtDebugPrint("xMarkerGameManager.solveCGZGame(cgz, solve):\t***[ Sending capture messages to all markers ]***")
