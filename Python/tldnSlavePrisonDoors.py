...
#                     panel SDL var     : Plate responder
respToPadSDL = {'tldnSlaveActivePanel01': respPlate1,
...
#                  activator id: responder name
activatorToResp = {actPlate1.id: respPlate1,
...
#                  Plate SDL name     , activator id
PlateSDLs = [('tldnSlaveActivePlate01', actPlate1.id),
...
#                 activator id:      plate SDL name
activatorToSDL = {actPlate1.id: 'tldnSlaveActivePlate01',
...
#                        paddle SDL name    :      plate SDL name
padSDLToplateSDL = {'tldnSlaveActivePanel01': 'tldnSlaveActivePlate01',
    ...
    def IEvalPlateAndPaddles(self, activator=None, fastforward=0):
        ...
        for PadSDL, resp in respToPadSDL.items():
            ...
            if fastforward:
                ...
                if type(resp.value) is list and len(resp.value) > 0:
